...
5. Read the user's rough idea, any stated constraints, Project Profile preferences, and relevant project context such as README, product docs, existing UI/API surfaces, and nearby source files.
