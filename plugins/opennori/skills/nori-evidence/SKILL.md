...
7. Heartbeat during longer verification, and finish live activity with `opennori activity finish --root <repo> --skill nori-evidence --summary "..." --json` when the evidence turn is complete.
