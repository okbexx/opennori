...
- architecture-before-implementation:
  1. Agent reads current goal, Product AC, Nori Profile, project evidence, and references.
...
- ECC: Map profiles/components/manifest/doctor thinking into Nori Profile, lifecycle manifest, doctor, and Architecture Profile review. Reason: Productized recovery and capability checks matter, but they must serve the acceptance loop.
