...
- `test/module-boundaries.test.js`: architecture boundary guards for type imports, MCP read-only scope, generated Markdown authority, lifecycle adapter parsing, and narrow command-module authority where regressions are likely.
